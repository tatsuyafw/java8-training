...
import static chapter3.exercise13.ColorTransformer.changeUnaryOperator;
...
public class LatentImage {
    ...
    public LatentImage strictTransform(ImageTransformer f) {
        Image image = this.toImage();
        return new LatentImage(Transformer.transform(image, f));
    }
